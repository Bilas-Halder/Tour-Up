            ...
            <Carousel fade>
                <Carousel.Item className="carousel-items" >
                    ...
                    <div className="carousel-texts text-start">
                        ...
                        <NavLink
                            to={{
                                pathname: `/bookpackage/${bannerData[0]?._id}`,
                                state: { from: "banner" }
                            }}
                            className="primary-btn banner-btn">Book Now</NavLink>
                    </div>
                ...
                <Carousel.Item className="carousel-items" >
                    ...
                    <div className="carousel-texts text-start">
                        ...
                        <NavLink
                            to={{
                                pathname: `/bookpackage/${bannerData[1]?._id}`,
                                state: { from: "banner" }
                            }} className="primary-btn banner-btn">Book Now</NavLink>
                    </div>
                ...
                <Carousel.Item className="carousel-items" >
                    ...
                    <div className="carousel-texts text-start">
                        ...
                        <NavLink
                            to={{
                                pathname: `/bookpackage/${bannerData[2]?._id}`,
                                state: { from: "banner" }
                            }}
                            className="primary-btn banner-btn">Book Now</NavLink>
                    </div>
